...
def main():
    ...
    step_1 = ks.applications.VGG19(weights='imagenet', include_top=False)(inputs)
    step_2 = ks.layers.Flatten()(step_1.outputs)
    step_3 = ks.layers.Dense(256, activation='relu')(step_2)
    step_4 = ks.layers.Dense(128, activation='relu')(step_3)
    step_5 = ks.layers.Dropout(rate=0.5)(step_4)
    output = ks.layers.Dense(len(CLASSES), activation='softmax')(step_5)
